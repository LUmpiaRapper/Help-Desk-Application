export function SkeletonCard({ className = '' }) {
  return (
    <div className={`bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-6 ${className}`}>
      <div className="h-3 w-24 bg-gray-200 dark:bg-slate-700 rounded animate-pulse mb-3" />
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 overflow-hidden">
      ...
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="flex items-center gap-4 px-4 py-3 border-b border-gray-50 dark:border-slate-700/50 last:border-0">
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-6 space-y-4">
        ...
        <div className="h-20 w-full bg-gray-200 dark:bg-slate-700 rounded animate-pulse" />
        <div className="h-12 w-full bg-gray-200 dark:bg-slate-700 rounded animate-pulse" />
      </div>
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-6 space-y-4">
        <div className="h-5 w-32 bg-gray-200 dark:bg-slate-700 rounded animate-pulse" />
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="h-16 w-full bg-gray-200 dark:bg-slate-700 rounded animate-pulse" />
        ))}
      </div>
    </div>
  )
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-6 space-y-5">
        <div>
          <div className="h-4 w-16 bg-gray-200 dark:bg-slate-700 rounded animate-pulse mb-1" />
        ...
        <div>
          ...
          <div className="h-28 w-full bg-gray-200 dark:bg-slate-700 rounded animate-pulse" />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <div className="h-4 w-20 bg-gray-200 dark:bg-slate-700 rounded animate-pulse mb-1" />
            <div className="h-10 w-full bg-gray-200 dark:bg-slate-700 rounded animate-pulse" />
          </div>
          <div>
            <div className="h-4 w-16 bg-gray-200 dark:bg-slate-700 rounded animate-pulse mb-1" />
